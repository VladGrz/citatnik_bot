...
from data.database import user_reaction, change_likes_count, change_dislikes_count
...
async def set_like(call: CallbackQuery):
    ...
    if reaction == 'like':
        ...
        await change_likes_count(call.from_user.id, doc_id, 1)
    await call.message.edit_reply_markup(await form_like_dislike_kb(doc_id))
